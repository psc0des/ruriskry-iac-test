...
# SRI Composite: 44.2 / 100
#   Infrastructure: 60.0
#   Policy:         25.0
#   Historical:     80.0
#   Cost:           0.0
# Verdict:      APPROVED
# Reason:       Critical: Inbound NSG rule 'testing-ssh-port' allows SSH (port 22) from ANY source ('*'), exposing SSH to the entire internet. Immediate action required to restrict source or remove rule.
# Action ID:    836cb90b-1347-4427-81d7-d98e69cadaba
# IaC Tool:     terraform
# IaC Path:     infrastructure/terraform-prod
# Generated:    2026-03-06T06:11:44.177667+00:00
# =============================================================================
#
...
# ---------------------------------------------------------------------------
# 1. Find the azurerm_network_security_rule resource named "testing-ssh-port"
...
#
# resource "azurerm_network_security_rule" "testing_ssh_port" {  ← DELETE THIS BLOCK
#   name  = "testing-ssh-port"
#   ...
# }
...
# ---------------------------------------------------------------------------
resource "azurerm_network_security_rule" "testing_ssh_port" {
  name                        = "testing-ssh-port"
...
# ---------------------------------------------------------------------------
resource "azurerm_network_security_rule" "deny_testing_ssh_port_internet" {
  name                        = "deny-testing-ssh-port-internet"
  priority                    = 100        # Higher priority than testing-ssh-port (140)
  direction                   = "Inbound"
  access                      = "Deny"
  protocol                    = "Tcp"
  source_port_range           = "*"
