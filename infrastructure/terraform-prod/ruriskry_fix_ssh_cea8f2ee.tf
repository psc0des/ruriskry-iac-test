...
#   Cost:           0.0
# Verdict:      APPROVED
# Reason:       CRITICAL: Inbound Allow rule 'ssh' permits sourceAddressPrefix '*' to port 22 (SSH). This exposes SSH to the entire internet and is a major security risk.
# Action ID:    cea8f2ee-6372-4fb1-8886-b5e717ab6e3a
# IaC Tool:     terraform
# IaC Path:     infrastructure/terraform-prod
# Generated:    2026-03-06T07:20:07.906359+00:00
# =============================================================================
#
