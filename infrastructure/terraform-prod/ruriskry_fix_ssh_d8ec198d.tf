...
#   Cost:           0.0
# Verdict:      APPROVED
# Reason:       Critical security risk: inbound Allow rule 'ssh' exposes SSH (port 22) from Any source ('*') to the internet. This permits management access from everywhere. Immediate restriction required.
# Action ID:    d8ec198d-d280-4a34-bb61-177da2412b1a
# IaC Tool:     terraform
# IaC Path:     infrastructure/terraform-prod
# Generated:    2026-03-06T07:54:16.059913+00:00
# =============================================================================
#
