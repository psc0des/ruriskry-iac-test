...
#   Cost:           0.0
# Verdict:      APPROVED
# Reason:       Critical: Inbound Allow rule 'testing-ssh-port' exposes port 22 (SSH) to the entire internet (sourceAddressPrefix='*'). This is a severe security exposure and must be restricted immediately.
# Action ID:    7c1789d6-2a97-4283-975e-67abd8e81ad4
# IaC Tool:     terraform
# IaC Path:     infrastructure/terraform-prod
# Generated:    2026-03-06T06:13:34.993658+00:00
# =============================================================================
#
